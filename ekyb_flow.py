...
steps = ["", "CR verification", "ID Verification", "Expense Analysis", "Web Analysis", "Address verification", "Social Checks ", "Fraud Analysis", "PEP & AML"]
...
{
        "business_name": "Nymcard", "simah": "695-699",
        "loan_required": "200000",
        "term": "12",
        "rate": "15",
        "repayment": {
            "card_number": "78892911122****",
            "expiration": "15/09/2025",
            "cvv": "355"
        },
        "bank_account":
        {
            "bank_name": "Emirates NBD",
            "account_no": "18727733001023394",
            "iban_no": "ENBX113939238484901213",
            "swift_code": "S11234",
            "account_name": "Nymcard payments llc"
        }
}
...
def sentiment_scrape():
    ...
    if st.button("Get Analysis"):
        ...
        if hasattr(st.session_state, 'company_name'):
            company_name = st.session_state.company_name
            company_name = company_name.lower()
            with st.spinner(f"Getting Results for {company_name} .."):
                scrapes = {}
                sentiments = {}
...
def world_check():
    ...
    if st.button("Get Results"):
        ...
        if st.button("Next"):
            print(f"business step: {st.session_state.step_business}")
...
#     login_page()
    ...
    print(f"\n\n\nsession step: {st.session_state.step}\n\n")
